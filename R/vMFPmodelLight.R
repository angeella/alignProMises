#' @title von Mises Fisher Procrustes model light approach
...
vMFPmodelLight <- function(data, maxIt=10, t =.001, k = 0, Q = NULL, ref_ds = NULL, scaling = T, reflection= T, subj= F, centered = T, coord = NULL){
